FishingSlots::
	...
	db SAFARI_ZONE_CENTER,MAGIKARP,5,MAGIKARP,10,DRATINI,10,DRATINI,15
	...
	db UNKNOWN_DUNGEON_1,KABUTO,25,SEAKING,35,SEAKING,45,SEAKING,55
	db UNKNOWN_DUNGEON_3,OMANYTE,25,SEAKING,40,SEAKING,50,SEAKING,60
	db SILVER_CAVE_ROOM_2,GOLDEEN,40,SEAKING,40,DRATINI,15,DRAGONAIR,30
	db ROUTE_28,MAGIKARP,40,POLIWAG,40,POLIWAG,40,POLIWHIRL,40
	db SILVER_CAVE_OUTSIDE,MAGIKARP,40,POLIWAG,40,POLIWAG,40,POLIWHIRL,40
	db $ff
