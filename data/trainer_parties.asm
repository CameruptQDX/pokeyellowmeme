...
JrTrainerFData:
	...
	db 20,CUBONE,0
PokemaniacData:
	db 30,NIDOQUEEN,NIDOQUEEN,0 ; raven
	db 20,CUBONE,SLOWPOKE,0
	db 20,GASTLY,ODDISH,ZUBAT,0 ; cowboy shootin
	db 22,CHARMANDER,CUBONE,0
	db 25,SLOWPOKE,0
	db 58,CHARMELEON,LAPRAS,LICKITUNG,0
	db 23,RHYHORN,LICKITUNG,0
SuperNerdData:
	db 11,MAGNEMITE,VOLTORB,0
	db 12,GRIMER,VOLTORB,KOFFING,0
	db 24,VENOMOTH,KRABBY,KOFFING,0
	db 22,GRIMER,MUK,GRIMER,0
	db $FF,27,STARMIE,30,MAGNETON,0 ; editanon
	...
	db 41,RAPIDASH,0
	db 37,ALAKAZAM,SLOWBRO,MR_MIME,0 ; wingman
HikerData:
	...
	db $FF,22,PSYDUCK,24,PORYGON,30,KAKUNA,35,MAGIKARP,0 ;aaaa
	db 20,MACHOP,ONIX,0
...
BikerData:
	...
	db 29,LICKITUNG,JYNX,0 ;FB from rheg
	db 33,WEEZING,0
...
TamerData:
	db $FF,36,NIDOKING,38,PIDGEOT,37,CLOYSTER,0 ; HAbird
...
GiovanniData:
	...
	db $FF,53,HYPNO,54,ARBOK,54,BLASTOISE,55,PRIMEAPE,55,TAUROS,55,MEWTWO,0
RocketData:
	db 16,RATICATE,0
...
CooltrainerMData:
	...
	db 50,WIGGLYTUFF,AERODACTYL,JOLTEON,VILEPLUME,RHYDON,KABUTOPS,0 ; LRB victory road
...
CooltrainerFData:
	...
	db 53,EXEGGUTOR,NIDOKING,CLEFABLE,PIKACHU,0 ; star
	db 55,DODRIO,ELECTABUZZ,MUK,0 ; rool
...
RedData:
	db $FF,100,PIKACHU,90,VENUSAUR,90,CHARIZARD,90,BLASTOISE,90,JUMPEON,90,SNORLAX,0
