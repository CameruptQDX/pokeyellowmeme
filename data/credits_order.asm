...
; to go to the next set of credits texts.
	...
	db CRED_DIRECTOR, CRED_IWATA, CRED_TEXT_FADE_MON
	...
	db CRED_YAMAUCHI, CRED_SEKINE, CRED_SEYA, CRED_TEXT_FADE
	db CRED_YAMAUCHI, CRED_SHIMAMURA, CRED_SHIMOYAMADA, CRED_TEXT_MON
	...
	db CRED_CHARACTER_DESIGN, CRED_MURAKAWA, CRED_FUKUI, CRED_TEXT_FADE
	...
	db CRED_EXECUTIVE_PRODUCER, CRED_TAJIRI, CRED_TEXT_FADE_MON
	db CRED_COPYRIGHT
